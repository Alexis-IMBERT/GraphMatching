...
if __name__ == "__main__":
    ...
    cmap = gv.rand_cmap(
        101, type="bright", first_color_black=True, last_color_black=False, verbose=True
    )
    list_graphs = gp.load_graphs_in_list(path_to_graphs)
    cmap = "gist_ncar"

    ico_mesh = sio.load_mesh(
        os.path.join(project_path, "data/template_mesh/ico100_7.gii")
    )
