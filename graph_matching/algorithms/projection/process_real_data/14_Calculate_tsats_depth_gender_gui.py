...
if __name__ == "__main__":
    ...
    path_to_correspondence = os.path.join(
        project_path, "data/Matlab_MGM_affintiy_gen/gender_correspondence.pickle"
    )
    ...
    vb_sc.add_to_subplot(
        nodes_cb_obj, row=visb_sc_shape[0] - 1, col=visb_sc_shape[0] + 0, width_max=300
    )
    vb_sc.preview()
