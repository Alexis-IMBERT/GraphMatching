...
if __name__ == "__main__":
    ...
    cluster_dict = gca.create_clusters_lists(
        new_graphs, label_attribute=label_attribute
    )
    ...
    for i, graph in enumerate(new_graphs):
        ...
        Visualisation(
            graph=graph, title="graph_{:05d}".format(graph_num)
        ).save_as_pickle(path_to_save)
