...
cost = np.array(
    [[0.48, 0.585, 0.59, 0.485], [0.385, 0.48, 0.485, 0.39], [0.485, 0.59, 0.585, 0.48]]
)
...
class TestSns(TestCase):
    def test_sinkhorn_stage(self):
        ...
        x_result = np.array([[0.33909537], [0.23959371], [0.33909537]])
        y_result = np.array([[0.39853407], [0.49973079], [0.50163832], [0.40041806]])
    ...
    def test_conjugate_gradient(self):
        A = np.array([[4, 1], [1, 3]])
        b = np.array([[1], [2]])
        result = np.array([[0.09090909], [0.63636364]])
